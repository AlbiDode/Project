...
public class OpenLeagueAction implements IObjectActionDelegate {
	...
	public void run(IAction action) {
		ImplementationLeagueDialog dialog = new ImplementationLeagueDialog(shell);
