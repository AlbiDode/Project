...
public class BowlingItemProviderAdapterFactory extends BowlingAdapterFactory implements ComposeableAdapterFactory, IChangeNotifier, IDisposable {
	...
	/**
	 * This keeps track of the one adapter used for all {@link bowling.SpecialPlayer} instances.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected SpecialPlayerItemProvider specialPlayerItemProvider;

	/**
	 * This creates an adapter for a {@link bowling.SpecialPlayer}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Adapter createSpecialPlayerAdapter() {
		if (specialPlayerItemProvider == null) {
			specialPlayerItemProvider = new SpecialPlayerItemProvider(this);
		}

		return specialPlayerItemProvider;
	}
	...
	public void dispose() {
		...
		if (specialPlayerItemProvider != null) specialPlayerItemProvider.dispose();
	}
