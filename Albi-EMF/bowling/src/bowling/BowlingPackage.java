...
public interface BowlingPackage extends EPackage {
	 ...
	 * @generated
	 */
	String eNS_URI = "http://www.example.org/bowling";
	...
	/**
	 * The meta object id for the '{@link bowling.impl.SpecialPlayerImpl <em>Special Player</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see bowling.impl.SpecialPlayerImpl
	 * @see bowling.impl.BowlingPackageImpl#getSpecialPlayer()
	 * @generated
	 */
	int SPECIAL_PLAYER = 5;
	 ...
	 * @ordered
	 */
	int SPECIAL_PLAYER__NAME = PLAYER__NAME;
	 ...
	 * @ordered
	 */
	int SPECIAL_PLAYER__DATE_OF_BIRTH = PLAYER__DATE_OF_BIRTH;
	 ...
	 * @ordered
	 */
	int SPECIAL_PLAYER__HEIGHT = PLAYER__HEIGHT;
	 ...
	 * @ordered
	 */
	int SPECIAL_PLAYER__IS_PROFESSIONAL = PLAYER__IS_PROFESSIONAL;

	/**
	 * The feature id for the '<em><b>Medals</b></em>' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int SPECIAL_PLAYER__MEDALS = PLAYER_FEATURE_COUNT + 0;

	/**
	 * The number of structural features of the '<em>Special Player</em>' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int SPECIAL_PLAYER_FEATURE_COUNT = PLAYER_FEATURE_COUNT + 1;

	/**
	 * The number of operations of the '<em>Special Player</em>' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int SPECIAL_PLAYER_OPERATION_COUNT = PLAYER_OPERATION_COUNT + 0;
	...
	/**
	 * Returns the meta object for class '{@link bowling.SpecialPlayer <em>Special Player</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for class '<em>Special Player</em>'.
	 * @see bowling.SpecialPlayer
	 * @generated
	 */
	EClass getSpecialPlayer();

	/**
	 * Returns the meta object for the attribute '{@link bowling.SpecialPlayer#getMedals <em>Medals</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Medals</em>'.
	 * @see bowling.SpecialPlayer#getMedals()
	 * @see #getSpecialPlayer()
	 * @generated
	 */
	EAttribute getSpecialPlayer_Medals();
	...
	interface Literals {
		...
		/**
		 * The meta object literal for the '{@link bowling.impl.SpecialPlayerImpl <em>Special Player</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see bowling.impl.SpecialPlayerImpl
		 * @see bowling.impl.BowlingPackageImpl#getSpecialPlayer()
		 * @generated
		 */
		EClass SPECIAL_PLAYER = eINSTANCE.getSpecialPlayer();

		/**
		 * The meta object literal for the '<em><b>Medals</b></em>' attribute feature.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @generated
		 */
		EAttribute SPECIAL_PLAYER__MEDALS = eINSTANCE.getSpecialPlayer_Medals();
