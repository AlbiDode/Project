...
public class BowlingFactoryImpl extends EFactoryImpl implements BowlingFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			...
			case BowlingPackage.SPECIAL_PLAYER: return createSpecialPlayer();
			default:
	 ...
	 * @generated
	 */
	public SpecialPlayer createSpecialPlayer() {
		SpecialPlayerImpl specialPlayer = new SpecialPlayerImpl();
