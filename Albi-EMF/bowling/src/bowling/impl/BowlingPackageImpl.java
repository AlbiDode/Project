...
public class BowlingPackageImpl extends EPackageImpl implements BowlingPackage {
	 ...
	 * @generated
	 */
	private EClass specialPlayerEClass = null;
	 ...
	 * @generated
	 */
	public EClass getSpecialPlayer() {
		return specialPlayerEClass;
	}
	 ...
	 * @generated
	 */
	public EAttribute getSpecialPlayer_Medals() {
		return (EAttribute)specialPlayerEClass.getEStructuralFeatures().get(0);
	}
	...
	public void createPackageContents() {
		...
		specialPlayerEClass = createEClass(SPECIAL_PLAYER);
		createEAttribute(specialPlayerEClass, SPECIAL_PLAYER__MEDALS);
	...
	public void initializePackageContents() {
		...
		specialPlayerEClass.getESuperTypes().add(this.getPlayer());

		// Initialize classes, features, and operations; add parameters
		initEClass(playerEClass, Player.class, "Player", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getPlayer_Name(), ecorePackage.getEString(), "name", "Albi", 0, 1, Player.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getPlayer_DateOfBirth(), ecorePackage.getEDate(), "dateOfBirth", "10-30-1991", 0, 1, Player.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getPlayer_Height(), ecorePackage.getEDouble(), "height", "183.6", 0, 1, Player.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getLeague_Name(), ecorePackage.getEString(), "name", "Albania", 0, 1, League.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getTournament_Type(), this.getTournamentType(), "type", "Pro", 0, 1, Tournament.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getGame_Frames(), ecorePackage.getEInt(), "frames", "2", 0, 10, Game.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(specialPlayerEClass, SpecialPlayer.class, "SpecialPlayer", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getSpecialPlayer_Medals(), ecorePackage.getEInt(), "medals", "2", 0, 1, SpecialPlayer.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
