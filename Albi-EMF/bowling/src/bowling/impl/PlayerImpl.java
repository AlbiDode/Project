...
public class PlayerImpl extends MinimalEObjectImpl.Container implements Player {
	 ...
	 * @ordered
	 */
	protected static final String NAME_EDEFAULT = "Albi";
	 ...
	 * @ordered
	 */
	protected static final Date DATE_OF_BIRTH_EDEFAULT = (Date)EcoreFactory.eINSTANCE.createFromString(EcorePackage.eINSTANCE.getEDate(), "10-30-1991");
	 ...
	 * @ordered
	 */
	protected static final double HEIGHT_EDEFAULT = 183.6;
