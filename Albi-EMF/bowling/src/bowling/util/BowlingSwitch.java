...
public class BowlingSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case BowlingPackage.SPECIAL_PLAYER: {
				SpecialPlayer specialPlayer = (SpecialPlayer)theEObject;
				T result = caseSpecialPlayer(specialPlayer);
				if (result == null) result = casePlayer(specialPlayer);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Special Player</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Special Player</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseSpecialPlayer(SpecialPlayer object) {
		return null;
	}
