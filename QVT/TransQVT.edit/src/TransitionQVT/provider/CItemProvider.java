...
/**
 * This is the item provider adapter for a {@link TransitionQVT.C} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CItemProvider extends ElementItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_C_c_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_C_c_feature", "_UI_C_type"),
				 TransitionQVTPackage.Literals.C__C,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		C c = (C)object;
		return getString("_UI_C_type") + " " + c.getId();
	}
