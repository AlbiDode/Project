 ...
 * </p>
 * <ul>
 *   <li>{@link TransitionQVT.impl.CImpl#getC <em>C</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CImpl extends ElementImpl implements C {
	...
	protected EClass eStaticClass() {
		return TransitionQVTPackage.Literals.C;
	}
	...
	public void setC(String newC) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TransitionQVTPackage.C__C, oldC, c));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case TransitionQVTPackage.C__C:
				return getC();
		}
