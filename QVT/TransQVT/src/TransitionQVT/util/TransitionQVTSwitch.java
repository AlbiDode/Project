 ...
 * @generated
 */
public class TransitionQVTSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case TransitionQVTPackage.ROOT: {
				Root root = (Root)theEObject;
				T result = caseRoot(root);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case TransitionQVTPackage.A: {
				A a = (A)theEObject;
				T result = caseA(a);
			...
			case TransitionQVTPackage.ELEMENT: {
